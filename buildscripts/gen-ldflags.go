...
func genLDFlags(version string) string {
	...
	ldflagsStr := "-s -w"
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.Version=" + version
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.CopyrightYear=" + copyrightYear
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.ReleaseTag=" + releaseTag
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.CommitID=" + commitID()
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.ShortCommitID=" + commitID()[:12]
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.GOPATH=" + os.Getenv("GOPATH")
	ldflagsStr += " -X github.com/uitstor/uitstor/cmd.GOROOT=" + os.Getenv("GOROOT")
	return ldflagsStr
}
