...
// SiteReplicationAdd - PUT /uitstor/admin/v3/site-replication/add
...
// SRPeerJoin - PUT /uitstor/admin/v3/site-replication/join
//
...
// SRPeerBucketOps - PUT /uitstor/admin/v3/site-replication/bucket-ops?bucket=x&operation=y
...
// SRPeerReplicateIAMItem - PUT /uitstor/admin/v3/site-replication/iam-item
...
// SRPeerReplicateBucketItem - PUT /uitstor/admin/v3/site-replication/bucket-meta
...
// SiteReplicationInfo - GET /uitstor/admin/v3/site-replication/info
...
// SiteReplicationStatus - GET /uitstor/admin/v3/site-replication/status
...
// SiteReplicationMetaInfo - GET /uitstor/admin/v3/site-replication/metainfo
...
// SiteReplicationEdit - PUT /uitstor/admin/v3/site-replication/edit
...
// SRPeerEdit - PUT /uitstor/admin/v3/site-replication/peer/edit
//
...
// SiteReplicationRemove - PUT /uitstor/admin/v3/site-replication/remove
...
// SRPeerRemove - PUT /uitstor/admin/v3/site-replication/peer/remove
//
// used internally to tell current cluster to update endpoint for peer
