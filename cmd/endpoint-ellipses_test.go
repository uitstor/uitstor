...
func TestParseEndpointSet(t *testing.T) {
	testCases := []struct {
		...
		// Invalid range.
		{
			"http://uitstor{2...3}/export/set{1...0}",
			endpointSet{},
			false,
		},
		...
		{
			"http://uitstor{2...3}/export/set{1...64}",
			endpointSet{
				[]ellipses.ArgPattern{
					[]ellipses.Pattern{
						{
		...
		{
			"http://uitstor{1...64}.mydomain.net/data",
			endpointSet{
				[]ellipses.ArgPattern{
					[]ellipses.Pattern{
						{
		...
		{
			"http://rack{1...4}.mydomain.uitstor{1...16}/data",
			endpointSet{
				[]ellipses.ArgPattern{
					[]ellipses.Pattern{
						{
		...
		{
			"http://uitstor{0...15}.mydomain.net/data{0...1}",
			endpointSet{
				[]ellipses.ArgPattern{
					[]ellipses.Pattern{
						{
		...
		{
			"http://uitstor{2...3}/export/set{1...64}/test{1...2}",
			endpointSet{
				[]ellipses.ArgPattern{
					[]ellipses.Pattern{
						{
