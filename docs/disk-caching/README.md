...
To test this setup, access the MinIO gateway via browser or [`mc`](https://docs.min.io/docs/uitstor-client-quickstart-guide). You’ll see the uploaded files are accessible from all the MinIO endpoints.

## Explore Further

- [Disk cache design](https://github.com/uitstor/uitstor/blob/master/docs/disk-caching/DESIGN.md)
