...
authorize_url = "http://localhost:8080/auth/realms/uitstor/protocol/openid-connect/auth"
token_url = "http://localhost:8080/auth/realms/uitstor/protocol/openid-connect/token"
